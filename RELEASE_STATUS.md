...
1. The reserved Zenodo record is published and opened from a logged-out browser session.
2. Authors approve the aggregate clinical release and the manuscript has final ethics, funding, conflicts, and author-contribution text.

Participant-level institutional and linkage data are excluded from this release.
